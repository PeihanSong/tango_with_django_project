...
def populate():
    python_pages = [{'title': 'Official Python Tutorial', 'url': 'http://docs.python.org/3/tutorial/', 'views': 80},
    ...
    other_pages = [{'title': 'Bottle', 'url': 'http://bottlepy.org/docs/dev/', 'views': 60},
